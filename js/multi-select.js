...
function MultiSelectTag(el, customs = { shadow: false, rounded: true }) {
    ...
    tagColor.textColor = "#445569";
    tagColor.borderColor = "#44556983";
    tagColor.bgColor = "#D9D9D9";
    ...
    function createTag(option) {
        ...
        itemDiv.style.color = tagColor.textColor || '#445569';
        itemDiv.style.borderColor = tagColor.borderColor || '#44556983';
        itemDiv.style.background = tagColor.bgColor || '#D9D9D9';
